...
def mode_read(dev):
    ...
    print("{}{}".format("Track 1:", t1))
    print("{}{}".format("Track 2:", t2))
    print("{}{}".format("Track 3:", t3))
...
def mode_compare(dev):
    ...
    if b1 == t1 and b2 == t2 and t3 == t3:
        ...
        print("{}{}".format("Track 1:", b1))
        print("{}{}".format("Track 2:", b2))
        print("{}{}".format("Track 3:", b3))
